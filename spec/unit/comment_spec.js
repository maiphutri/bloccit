const sequelize = require("../../src/db/models/index").sequelize,
      Topic     = require("../../src/db/models/index").Topic,
      Post      = require("../../src/db/models/index").Post,
      User      = require("../../src/db/models/index").User,
      Comment   = require("../../src/db/models/index").Comment;
